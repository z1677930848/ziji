...
if [ -f /opt/cdnfly/master/view/upgrade.so ]; then
	...
	sed -i "s/https:\/\/{host}\/master\/upgrades/http:\/\/{host}\/\/master\/upgrades/g" /opt/cdnfly/master/tasks/upgrade.so
	sed -i "s/update-us.cdnfly.cn/auth.cdnfly.cn\/\/\/\/\//g" /opt/cdnfly/master/tasks/upgrade.so
	sed -i "s/update-cn.cdnfly.cn/auth.cdnfly.cn\/\/\/\/\//g" /opt/cdnfly/master/tasks/upgrade.so
